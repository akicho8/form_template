current_records.collect {|e|
  {
    "メールアドレス" => link_to(e.email, [:new, *ns_prefix, :type018_user, activate_token: e.activate_token]),
    "本登録日時"     => e.activated_at&.to_s(:ymdhms),
    "本登録者数"     => e.type018_users.count,
  }.merge({"操作" => [
        link_to("本登録", [:new, *ns_prefix, :type018_user, activate_token: e.activate_token]),
