...
class CodeArticle
  ...
  memory_record [
    ...
    {key: "6f17fa91a01674093d748338abc9919e", name: "全角や半角での入力を自動化するには？",       point: "watch で変数の変更を監視する。watch 内でさらに変更しても無限ループにならない。"},
    {key: "11ab14f694fb5fca55220fc0a6d34725", name: "パスワードを生成するには？",                 point: "Vue 側は単に変数 a を更新しただけ。ビューと切り離して考える"},
    {key: "448bdde71250cd41c9963ded21364ec9", name: "パスワードの強度をバーで表現するには？",     point: "watch より computed 推奨"},
    {key: "25b38ccd6aa787e5ac97d5a64ccaaf5d", name: "郵便番号に対応する地図を表示するには？",     point: ""},
    {key: "75efb705e058fd7eb8e43360cf179336", name: "AJAX するには？",                            point: "axios ライブラリ便利 (Vue関係ない)"},
    {key: "893e480822c655a75a62b3a2be25fe7b", name: "逆ポ電卓アプリを作るには？",                 point: "v-for で繰り返し"},
    ...
    {key: "c4f0d596a82ca3cd3087acedc33547fd", name: "入力し続けないとリダイレクトするには？",     point: ""},
    ...
    {key: "0c47662e6cce929f5fa83f73190462fd", name: "位置情報",                                   point: ""},
  ]
