class ShowCaseInfo
  ...
  static_record [
    ...
    {:model => Type004Article, :confirm => true,  :tables => 1, :desc => "従来の単一ファイルアップロードフォーム。",                                },
    ...
    {:model => Type010Article, :confirm => false, :tables => 2, :desc => "1対多。ヤフオクの商品画像アップなどを想定。画像にコメントを追加できる。", },
    ...
    {:model => Type014Article, :confirm => false, :tables => 1, :desc => "HTML5のレアな機能満載",                                                   },
